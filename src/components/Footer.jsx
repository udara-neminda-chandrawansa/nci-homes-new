        ...
        <div className="flex w-3/5 max-[992px]:w-full">
          <div className="flex w-1/2 max-[992px]:w-full">
            ...
            <div className="w-1/2 flex gap-3 items-center max-[992px]:pl-4">
              <Link href="https://www.facebook.com/ncihomespvtltd/" className="h-fit">
                <svg
              ...
              <Link href="https://www.instagram.com/explore/tags/ncihomes/" className="h-fit">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <Link href="https://www.linkedin.com/in/ncihomes/?originalSubdomain=lk" className="h-fit">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
